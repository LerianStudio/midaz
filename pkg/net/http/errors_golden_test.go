...
func allSentinels() map[string]error {
	return map[string]error{
		...
		"ErrAccountBlockedTransactionRestriction":     constant.ErrAccountBlockedTransactionRestriction,
		"ErrAccountExceptionNotFound":                 constant.ErrAccountExceptionNotFound,
		"ErrNoAccountExceptionsFound":                 constant.ErrNoAccountExceptionsFound,
		"ErrInvalidAccountExceptionValidityWindow":    constant.ErrInvalidAccountExceptionValidityWindow,
