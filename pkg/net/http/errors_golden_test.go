...
func allSentinels() map[string]error {
	return map[string]error{
		...
		"ErrReservationDeliveryModeInvalid":           constant.ErrReservationDeliveryModeInvalid,
		"ErrReservationOutcomeInvalid":                constant.ErrReservationOutcomeInvalid,
		"ErrReservationOutcomeIDRequired":             constant.ErrReservationOutcomeIDRequired,
		"ErrReservationOutcomeConflict":               constant.ErrReservationOutcomeConflict,
