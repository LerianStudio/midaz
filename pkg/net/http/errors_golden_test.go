...
func allSentinels() map[string]error {
	return map[string]error{
		...
		"ErrInvalidScriptFormat":                      constant.ErrInvalidScriptFormat,
		...
		"ErrInvalidDSLFileFormat":                     constant.ErrInvalidDSLFileFormat,
		"ErrEmptyDSLFile":                             constant.ErrEmptyDSLFile,
