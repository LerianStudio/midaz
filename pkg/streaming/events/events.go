...
// RouteKey returns the hyphenated route-grammar form of Key():
// lib-streaming's route-key regex rejects underscores, so the
// underscore-canonical key folds to hyphen for the RouteDefinition.Key
// only.
