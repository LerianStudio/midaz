...
// fee_charge.applied tests so Subject assertions are exact-match.
const feesAppliedTransactionID = "0190d9e1-7c2a-7000-8000-0000000000a1"

// feesAppliedOrgID is the deterministic organization scope for fee_charge.applied
// event tests.
const feesAppliedOrgID = "0190d9e1-7c2a-7000-8000-0000000000a3"

// feesAppliedLedgerID is the deterministic ledger scope for fee_charge.applied event
// tests.
...
// fee_charge.applied event tests.
