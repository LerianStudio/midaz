...
//
//	mockgen -destination=logger_mock.go -package=mmigration github.com/LerianStudio/lib-commons/v2/commons/log Logger
//

// Package mmigration is a generated GoMock package.
package mmigration
