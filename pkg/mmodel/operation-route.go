...
type OperationRoute struct {
	...
	Type string `json:"type,omitempty" example:"source" enum:"source,destination"`
...
type CreateOperationRouteInput struct {
	...
	// The type of the operation route.
	Type string `json:"type,omitempty" validate:"required" example:"source" enum:"source,destination"`
