...
func TestHashMD5(t *testing.T) {
	tests := []struct {
		...
		{"request:12345", "76478daaccd04339585994ba2bd7df5b"},
		{"hello world", "5eb63bbbe01eeed093cb22bb8f5acdc3"},
		{"", "d41d8cd98f00b204e9800998ecf8427e"}, // Hash MD5 da string vazia
		{"GoLangTest", "722e0332cea99cebca8b283e2ee89d50"},
	}

	for _, tt := range tests {
		result := HashMD5(tt.input)
		if result != tt.expected {
			t.Errorf("hashMD5(%q) = %q; esperado %q", tt.input, result, tt.expected)
		}
	}
}
