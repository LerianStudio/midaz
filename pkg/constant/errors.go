...
var (
	...
	ErrRequestTooLarge                          = errors.New("0144")
	ErrAuthorizerEngineNotInitialized           = errors.New("0145")
	ErrIntegerOverflow                          = errors.New("0146")
	ErrIntegerUnderflow                         = errors.New("0147")
	ErrPreparedTransactionNil                   = errors.New("0148")
	ErrPreparedTxStoreNil                       = errors.New("0149")
	ErrPreparedTxCapacityExceeded               = errors.New("0150")
	ErrPreparedTxAlreadyExists                  = errors.New("0151")
	ErrPreparedTxRetryLimitExceeded             = errors.New("0152")
	ErrWALReplayStrictModeRejected              = errors.New("0153")
	ErrWALPathEmpty                             = errors.New("wal path cannot be empty")
	ErrWALWriterClosing                         = errors.New("wal writer is closing")
	...
	ErrMessagePayloadEmpty                      = errors.New("message payload cannot be empty")
	...
	ErrPeerShardRangesRequired                  = errors.New("AUTHORIZER_PEER_SHARD_RANGES is required when configuring multiple peers")
	ErrPeerShardRangeCannotInfer                = errors.New("cannot infer peer shard range from local ownership")
	ErrPeerOwnsAllShards                        = errors.New("peer instances configured but local instance owns all shards")
