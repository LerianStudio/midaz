...
func TestIntegration_Portfolio_UpdateAndGet(t *testing.T) {
    ...
    var portfolio struct{ ID string `json:"id"` }
    ...
    if err != nil || code != 200 { t.Fatalf("get portfolio: code=%d err=%v body=%s", code, err, string(body)) }
    ...
    if err != nil || code != 200 { t.Fatalf("update portfolio: code=%d err=%v body=%s", code, err, string(body)) }
}
...
func TestIntegration_Segment_UpdateAndGet(t *testing.T) {
    ...
    var segment struct{ ID string `json:"id"` }
    ...
    if err != nil || code != 200 { t.Fatalf("get segment: code=%d err=%v body=%s", code, err, string(body)) }
    ...
    if err != nil || code != 200 { t.Fatalf("update segment: code=%d err=%v body=%s", code, err, string(body)) }
}
