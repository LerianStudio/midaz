...
// TestChaos_MongoDB_RestartGraceful simulates a graceful restart of the MongoDB
// service to verify that metadata operations remain functional.
//
// This chaos experiment ensures that the system can handle a temporary unavailability
// of the metadata database and recover without affecting the ability to read and
// write metadata.
