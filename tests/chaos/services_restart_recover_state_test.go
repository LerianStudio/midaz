// Package chaos provides chaos engineering tests for the Midaz platform.
// This file contains tests for service restarts and state recovery.
package chaos
...
// TestChaos_ServicesRestart_RecoverState simulates service restarts to verify that
// they can recover and that their state remains accessible.
//
// This chaos experiment individually restarts the onboarding and transaction services
// and then confirms that they become healthy and can still serve data created
// before the restart.
