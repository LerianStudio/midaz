...
// TestChaos_CacheFlush_RehydrateNoNegative simulates a cache flush event to ensure
// that the system can gracefully rehydrate the cache from the database without
// data loss or corruption.
//
// This test verifies that even if the entire cache is wiped, balances are correctly
// restored from the database, preventing inconsistencies such as negative balances.
