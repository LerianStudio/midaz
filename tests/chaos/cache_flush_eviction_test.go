...
func TestChaos_CacheFlush_RehydrateNoNegative(t *testing.T) { //nolint:paralleltest // chaos tests interact with shared Docker infrastructure
	shouldRunChaos(t)

	cleanup := h.StartLogCapture([]string{"midaz-transaction", "midaz-onboarding", "midaz-valkey"}, "CacheFlush_RehydrateNoNegative")
	defer cleanup()
