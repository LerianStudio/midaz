...
//
//nolint:cyclop,funlen // chaos test covers multiple failure injection steps; splitting would obscure the test scenario
func TestChaos_RollingRestarts_UnderLoad_Idempotent(t *testing.T) { //nolint:paralleltest // chaos tests interact with shared Docker infrastructure
	shouldRunChaos(t)
