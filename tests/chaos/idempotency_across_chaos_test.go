...
// TestChaos_IdempotencyAcrossChaos_SingleNetEffect verifies that idempotency is
// maintained even when network disruptions and service restarts occur.
//
// This chaos experiment repeatedly sends the same idempotent request while
// simulating service pauses and restarts. It ensures that the transaction is
// processed exactly once, preventing duplicate operations and maintaining data
// consistency.
