...
// TestChaos_HardKillVsStop_ServicesDuringTraffic simulates service failures under
// active traffic to verify the system's resilience and data integrity.
//
// This chaos experiment subjects the transaction and onboarding services to both
// hard kills (ungraceful shutdowns) and graceful stops while write operations are
// in progress. It ensures that the services can recover without data loss.
