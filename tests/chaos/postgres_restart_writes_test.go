...
// TestChaos_PostgresRestart_DuringWrites simulates a PostgreSQL primary restart
// during a continuous stream of write operations to verify data integrity and
// system recovery.
//
// This chaos experiment ensures that the system can handle a database failure,
// recover gracefully, and maintain the correctness of account balances without
// losing any transactions that were successfully processed.
