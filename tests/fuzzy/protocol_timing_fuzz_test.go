...
// This file contains tests that fuzz protocol-level behavior, such as request timing and idempotency.
package fuzzy
...
// TestFuzz_Protocol_RapidFireAndRetries fuzzes the system's behavior under
// high-frequency requests and idempotent retries.
//
// This test simulates a "rapid-fire" scenario by sending a burst of mixed
// inflow and outflow transactions with minimal delays. It also tests the
// idempotency mechanism by repeatedly sending the same request with an
// idempotency key.
