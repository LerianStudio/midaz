...
// This file contains tests for handling malformed and unexpected HTTP headers.
package fuzzy
...
// TestFuzz_Headers_MissingDuplicated_InvalidAuth validates the server's behavior
// when receiving missing, duplicated, or invalid HTTP headers.
//
// This test ensures that the API gateway and services can handle various header-related
// edge cases without crashing or returning 5xx errors. It covers scenarios such as:
//   - Missing or invalid Authorization tokens.
//   - Duplicated headers (e.g., X-Request-Id).
//   - Missing Content-Type on POST requests.
