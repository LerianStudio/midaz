...
help:
	...
	@echo ""
	@echo "CI Gates:"
	@echo "  make ci                          - Run the fast CI gate (lint + telemetry gates + unit tests)"
	@echo "  make ci-tests                    - Run the heavier integration/property/chaos test matrix"
	@echo ""
	@echo ""
	@echo "Code Quality Commands:"
	@echo "  make lint                        - Run linting on all components"
	@echo "  make lint-fix                    - Apply golangci-lint --fix across all components (mutating)"
	...
	@echo "  make check-telemetry             - Verify telemetry/observability enforcement gates"
