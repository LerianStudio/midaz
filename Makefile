...
help:
	...
	@echo "  make test-integration            - Run integration tests with testcontainers (CHAOS=1 for chaos tests)"
	...
	@echo "  test-integration:  LOW_RESOURCE, CHAOS=1 (testcontainers-based, no external services needed)"
