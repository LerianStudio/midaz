...
#   - ./scripts/verify-api-docs.sh script (component-local)
#   - API annotations in Go code (@Summary, @Description, etc.)
#
# Generated files (under the component's ./api directory):
...
generate-docs-all:
	$(call title1,"Generating Swagger documentation with coverage verification")
