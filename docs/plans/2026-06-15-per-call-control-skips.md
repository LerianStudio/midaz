...
| 4 | **Audit + hardening (release gate):** honored skips persisted to typed columns + streaming event across the full wire path; OpenAPI/llms-full/docs; cross-surface integration suite | 4.1, 4.2, 4.3 | ⏳ Doing — Epic 4.1 ✅ (4a tx `c7caf2b2f` + 4b acct `244323320`); 4c next: 4.2 testcontainer + 4.3 docs |
