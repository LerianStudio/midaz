...
- lib-commons: `github.com/LerianStudio/lib-commons/v6` v6.4.0; `lib-observability/v2` v2.1.1.
...
- lib-commons v6 (`github.com/LerianStudio/lib-commons/v6/commons/...`, currently v6.4.0): app config, env/security/pointer helpers (`libCommons`), Redis, HTTP helpers (`libHTTP`, non-observability), circuit breaker, tenant managers (`tm*`).
