...
- lib-commons v6 (`github.com/LerianStudio/lib-commons/v6/commons/...`, currently v6.2.0): app config, env/security/pointer helpers (`libCommons`), Redis, HTTP helpers (`libHTTP`, non-observability), circuit breaker, tenant managers (`tm*`).
