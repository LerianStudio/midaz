...
type Config struct {
	...
	RabbitMQProducerUser      string `env:"RABBITMQ_PRODUCER_USER"`
	RabbitMQProducerPass      string `env:"RABBITMQ_PRODUCER_PASS"`
...
func InitConsumer() *ConsumerService {
	...
	rabbitProducerSource := fmt.Sprintf("%s://%s:%s@%s:%s",
		cfg.RabbitURI, cfg.RabbitMQProducerUser, cfg.RabbitMQProducerPass, cfg.RabbitMQHost, cfg.RabbitMQPortHost)

	rabbitMQConnection := &libRabbitmq.RabbitMQConnection{
		ConnectionStringSource: rabbitProducerSource,
		HealthCheckURL:         cfg.RabbitMQHealthCheckURL,
		Host:                   cfg.RabbitMQHost,
		Port:                   cfg.RabbitMQPortAMQP,
		User:                   cfg.RabbitMQProducerUser,
		Pass:                   cfg.RabbitMQProducerPass,
		Logger:                 logger,
	}

	rabbitMQProducerRepository := rabbitmq.NewProducerRabbitMQ(rabbitMQConnection)
	...
	useCase := &commands.UseCase{
		...
		RabbitMQRepo:    rabbitMQProducerRepository,
	}
