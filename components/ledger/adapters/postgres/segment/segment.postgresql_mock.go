...
// Source: ./components/ledger/adapters/postgres/segment/segment.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/postgres/segment/segment.postgresql.go -destination=./components/ledger/adapters/postgres/segment/segment.postgresql_mock.go -package=segment
//
