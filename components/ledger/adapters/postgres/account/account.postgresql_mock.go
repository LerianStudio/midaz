...
// Source: ./components/ledger/adapters/postgres/account/account.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/postgres/account/account.postgresql.go -destination=./components/ledger/adapters/postgres/account/account.postgresql_mock.go -package=account
//
