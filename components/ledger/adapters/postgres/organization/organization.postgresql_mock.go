...
// Source: ./components/ledger/adapters/postgres/organization/organization.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/postgres/organization/organization.postgresql.go -destination=./components/ledger/adapters/postgres/organization/organization.postgresql_mock.go -package=organization
//
