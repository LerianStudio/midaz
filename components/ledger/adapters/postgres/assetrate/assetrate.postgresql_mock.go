...
// Source: ./components/ledger/adapters/postgres/assetrate/assetrate.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/postgres/assetrate/assetrate.postgresql.go -destination=./components/ledger/adapters/postgres/assetrate/assetrate.postgresql_mock.go -package=assetrate
//
