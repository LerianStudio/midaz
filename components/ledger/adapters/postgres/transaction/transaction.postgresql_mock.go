...
// Source: ./components/ledger/adapters/postgres/transaction/transaction.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/postgres/transaction/transaction.postgresql.go -destination=./components/ledger/adapters/postgres/transaction/transaction.postgresql_mock.go -package=transaction
//
