...
// Source: ./components/ledger/adapters/postgres/ledger/ledger.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/postgres/ledger/ledger.postgresql.go -destination=./components/ledger/adapters/postgres/ledger/ledger.postgresql_mock.go -package=ledger
//
