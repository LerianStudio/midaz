...
// Source: ./components/ledger/adapters/rabbitmq/consumer.rabbitmq.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/rabbitmq/consumer.rabbitmq.go -destination=./components/ledger/adapters/rabbitmq/consumer.rabbitmq_mock.go -package=rabbitmq
//
