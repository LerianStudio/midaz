...
// Source: ./components/ledger/adapters/rabbitmq/producer.rabbitmq.go
//
// Generated by this command:
//
//	mockgen -source=./components/ledger/adapters/rabbitmq/producer.rabbitmq.go -destination=./components/ledger/adapters/rabbitmq/producer.rabbitmq_mock.go -package=rabbitmq
//
