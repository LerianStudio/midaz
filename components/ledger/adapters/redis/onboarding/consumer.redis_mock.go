...
// Source: components/ledger/adapters/redis/onboarding/consumer.redis.go
//
// Generated by this command:
//
//	mockgen -source=components/ledger/adapters/redis/onboarding/consumer.redis.go -destination=components/ledger/adapters/redis/onboarding/consumer.redis_mock.go -package=redis
//
