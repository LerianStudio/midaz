...
const (
	...
	AccountProto_GetByFilters_FullMethodName = "/account.AccountProto/GetByFilters"
)
...
func (c *accountProtoClient) GetByFilters(ctx context.Context, in *GetByFiltersRequest, opts ...grpc.CallOption) (*ManyAccountsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ManyAccountsResponse)
	err := c.cc.Invoke(ctx, AccountProto_GetByFilters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccountProtoServer) GetByFilters(context.Context, *GetByFiltersRequest) (*ManyAccountsResponse, error) {
...
func _AccountProto_GetByFilters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByFiltersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountProtoServer).GetByFilters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountProto_GetByFilters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountProtoServer).GetByFilters(ctx, req.(*GetByFiltersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountProto_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccountProto_GetByFilters_Handler,
		},
	},
