...
type Account struct {
	...
	OnHoldBalance    float32 `protobuf:"fixed32,4,opt,name=on_hold_balance,json=onHoldBalance,proto3" json:"on_hold_balance,omitempty"`
	BalanceScale     float32 `protobuf:"fixed32,5,opt,name=balance_scale,json=balanceScale,proto3" json:"balance_scale,omitempty"`
...
func (x *Account) GetAvailableBalance() float32 {
	if x != nil {
...
func (x *Account) GetOnHoldBalance() float32 {
	if x != nil {
...
func (x *Account) GetBalanceScale() float32 {
	if x != nil {
...
func (x *UpdateRequest) GetAvailableBalance() float32 {
	if x != nil {
		return x.AvailableBalance
	}
	return 0
...
func (x *UpdateRequest) GetOnHoldBalance() float32 {
	if x != nil {
		return x.OnHoldBalance
	}
	return 0
...
func (x *UpdateRequest) GetBalanceScale() float32 {
	if x != nil {
		return x.BalanceScale
	}
	return 0
...
var file_proto_account_account_proto_rawDesc = []byte{
	...
	0x02, 0x52, 0x0d, 0x6f, 0x6e, 0x48, 0x6f, 0x6c, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65,
	0x12, 0x23, 0x0a, 0x0d, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x63, 0x61, 0x6c,
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0c, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65,
