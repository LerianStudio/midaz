...
import (
	...
	onbMongo "github.com/LerianStudio/midaz/v3/components/ledger/adapters/mongodb/onboarding"
	txMongo "github.com/LerianStudio/midaz/v3/components/ledger/adapters/mongodb/transaction"
...
// allowing onboarding operations to call balance operations directly (in-process).
