...
// multiTenantEnabled && pgManager != nil && tenantCache != nil, for any
...
func TestProperty_BalanceSyncWorker_PredicateEqualsEnabledAndPGManagerNonNil(t *testing.T) {
	...
	require.NoError(t, err,
		"Property violated: BalanceSyncWorker.isMultiTenantReady() != (multiTenantEnabled && pgManager != nil && tenantCache != nil)")
}
