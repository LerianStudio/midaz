...
func (infra *chaosBootstrapInfra) buildProxiedConfig(t *testing.T) *Config {
	...
	return &Config{
		...
		TxnPrefixedPrimaryDBPort:     portStr,
		...
		TxnPrefixedReplicaDBPort:     portStr,
...
func TestIntegration_Chaos_InitPostgres_SingleTenantConnectionLoss(t *testing.T) {
	...
	chaos.AssertRecoveryWithin(t, func() error {
		recoveryResult, recoveryErr := initTransactionSingleTenantPostgres(cfg, logger)
	...
	recoveredResult, err := initTransactionSingleTenantPostgres(cfg, logger)
...
func TestIntegration_Chaos_InitPostgres_MultiTenantConnectionLoss(t *testing.T) {
	...
	chaos.AssertRecoveryWithin(t, func() error {
		recoveryResult, recoveryErr := initTransactionMultiTenantPostgres(opts, cfg, logger)
		if recoveryResult != nil {
			closePGConnection(recoveryResult.connection)
		}
	...
	recoveredResult, err := initTransactionMultiTenantPostgres(opts, cfg, logger)
