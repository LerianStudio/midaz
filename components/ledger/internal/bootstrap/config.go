...
type Config struct {
	...
	// Streaming SASL/TLS auth is owned by lib-streaming: it reads the
	// STREAMING_SASL_* and STREAMING_TLS_* env vars via LoadConfig and wires
	// the broker dial itself, so midaz does not parse those knobs here.
