...
// Source: github.com/LerianStudio/midaz/v4/components/ledger/internal/crm/adapters/mongodb/alias (interfaces: Repository)
//
...
func (m *MockRepository) Create(arg0 context.Context, arg1 string, arg2 *mmodel.Instrument) (*mmodel.Instrument, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Find(arg0 context.Context, arg1 string, arg2, arg3 uuid.UUID, arg4 bool) (*mmodel.Instrument, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1 string, arg2 uuid.UUID, arg3 http.QueryHeader, arg4 bool) ([]*mmodel.Instrument, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 string, arg2, arg3 uuid.UUID, arg4 *mmodel.Instrument, arg5 []string) (*mmodel.Instrument, error) {
	m.ctrl.T.Helper()
