...
// Source: github.com/LerianStudio/midaz/components/ledger/internal/domain/account (interfaces: Repository)
//
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1, arg2, arg3 uuid.UUID) ([]*account.Account, error) {
	m.ctrl.T.Helper()
