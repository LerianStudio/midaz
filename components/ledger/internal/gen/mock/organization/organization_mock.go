...
// Source: github.com/LerianStudio/midaz/components/ledger/internal/domain/onboarding/organization (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=../../../gen/mock/organization/organization_mock.go --package=mock . Repository
//
...
import (
	...
	organization "github.com/LerianStudio/midaz/components/ledger/internal/domain/onboarding/organization"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *organization.Organization) (*organization.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Find(arg0 context.Context, arg1 uuid.UUID) (*organization.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindAll(arg0 context.Context) ([]*organization.Organization, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) FindAll(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockRepository)(nil).FindAll), arg0)
}

// ListByIDs mocks base method.
func (m *MockRepository) ListByIDs(arg0 context.Context, arg1 []uuid.UUID) ([]*organization.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 uuid.UUID, arg2 *organization.Organization) (*organization.Organization, error) {
	m.ctrl.T.Helper()
