...
// Source: github.com/LerianStudio/midaz/components/ledger/internal/domain/ledger (interfaces: Repository)
//
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1 uuid.UUID) ([]*ledger.Ledger, error) {
	m.ctrl.T.Helper()
