...
// Source: components/ledger/internal/adapters/redis/onboarding/consumer.redis.go
//
// Generated by this command:
//
//	mockgen -source=components/ledger/internal/adapters/redis/onboarding/consumer.redis.go -destination=components/ledger/internal/adapters/redis/onboarding/consumer.redis_mock.go -package=redis
//
