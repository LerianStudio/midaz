...
// check-docs.sh) consumes. It is the single document carrying both the /v1 and /v2
// operations. The legacy swaggo/openapi-generator files it once sat beside have been
// retired.
