...
// under /v1, 41 under /v2), 186 operations — served on the single root server "/".
func TestUnifiedHumaContractIsSingleDocument(t *testing.T) {
	...
	require.Len(t, doc.Paths, 113, "single document must enumerate every versioned path key")
	require.Equal(t, 72, v1, "path keys under /v1")
	require.Equal(t, 41, v2, "path keys under /v2")
	require.Equal(t, 186, ops, "operations across both versions")
