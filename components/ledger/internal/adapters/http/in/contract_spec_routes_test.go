...
// share one component registry, so the union is a single spec — 125 path keys (72
// under /v1, 53 under /v2), 204 operations — served on the single root server "/".
func TestUnifiedHumaContractIsSingleDocument(t *testing.T) {
	...
	require.Equal(t, 53, v2, "path keys under /v2")
