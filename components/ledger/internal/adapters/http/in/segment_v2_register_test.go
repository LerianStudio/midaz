...
// TestRegisterSegmentV2Routes_NoDuplicateOperationIDs asserts every operationId in the
...
func TestRegisterSegmentV2Routes_NoDuplicateOperationIDs(t *testing.T) {
	t.Parallel()
