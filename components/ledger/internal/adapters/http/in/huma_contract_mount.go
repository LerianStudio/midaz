...
type LegacyError struct {
	...
	Instance   string         `json:"instance,omitempty" doc:"Reference for this one occurrence of the error, to quote when reporting it. Absent when the request carried no trace. The /v2 contract carries this under the same name."`
