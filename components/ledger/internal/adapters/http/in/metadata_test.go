...
func TestMetadataIndexHandler_CreateMetadataIndex(t *testing.T) { //nolint:funlen
	t.Parallel()
...
func TestMetadataIndexHandler_GetAllMetadataIndexes(t *testing.T) { //nolint:gocognit,gocyclo,cyclop,funlen
	t.Parallel()
