...
// feesV2FullRoutes is the route surface RegisterFeesV2RoutesToApp mounts: the twelve
...
// mountFeesV2Routes wires RegisterFeesV2RoutesToApp on a /v2 group, mirroring the
...
func mountFeesV2Routes(app *fiber.App, auth *middleware.AuthClient, routeOptions *pkgHTTP.ProtectedRouteOptions) huma.API {
	...
	RegisterFeesV2RoutesToApp(apiV2, hAPI, auth,
		&PackageHandler{}, &FeeHandler{}, &BillingPackageHandler{}, &BillingCalculateHandler{}, routeOptions)
...
// TestRegisterFeesV2RoutesToApp_DoesNotMountFeeCalculate asserts the fee-calculate
...
func TestRegisterFeesV2RoutesToApp_DoesNotMountFeeCalculate(t *testing.T) {
