...
// Source: components/ledger/internal/adapters/postgres/transaction/transaction.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=components/ledger/internal/adapters/postgres/transaction/transaction.postgresql.go -destination=components/ledger/internal/adapters/postgres/transaction/transaction.postgresql_mock.go -package=transaction
//
...
func (m *MockRepository) FindAll(ctx context.Context, organizationID, ledgerID uuid.UUID, filter http0.QueryHeader) ([]*Transaction, http.CursorPagination, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindOrListAllWithOperations(ctx context.Context, organizationID, ledgerID uuid.UUID, ids []uuid.UUID, filter http0.QueryHeader) ([]*Transaction, http.CursorPagination, error) {
	m.ctrl.T.Helper()
