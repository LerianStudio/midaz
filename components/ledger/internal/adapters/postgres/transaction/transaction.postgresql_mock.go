...
//
//	mockgen --destination=transaction.postgresql_mock.go --package=transaction github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/transaction Repository
//
...
// HasPendingByAccount mocks base method.
func (m *MockRepository) HasPendingByAccount(ctx context.Context, organizationID, ledgerID, accountID uuid.UUID) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasPendingByAccount", ctx, organizationID, ledgerID, accountID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// HasPendingByAccount indicates an expected call of HasPendingByAccount.
func (mr *MockRepositoryMockRecorder) HasPendingByAccount(ctx, organizationID, ledgerID, accountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
