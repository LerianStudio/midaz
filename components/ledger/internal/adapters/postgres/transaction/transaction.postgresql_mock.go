...
func (m *MockRepository) FindAll(arg0 context.Context, arg1, arg2 uuid.UUID, arg3 http0.Pagination) ([]*Transaction, http.CursorPagination, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindOrListAllWithOperations(arg0 context.Context, arg1, arg2 uuid.UUID, arg3 []uuid.UUID, arg4 http0.Pagination) ([]*Transaction, http.CursorPagination, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOrListAllWithOperations", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].([]*Transaction)
	ret1, _ := ret[1].(http.CursorPagination)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockRepositoryMockRecorder) FindOrListAllWithOperations(arg0, arg1, arg2, arg3, arg4 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindOrListAllWithOperations", reflect.TypeOf((*MockRepository)(nil).FindOrListAllWithOperations), arg0, arg1, arg2, arg3, arg4)
}

// FindWithOperations mocks base method.
func (m *MockRepository) FindWithOperations(arg0 context.Context, arg1, arg2, arg3 uuid.UUID) (*Transaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindWithOperations", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*Transaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindWithOperations(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindWithOperations", reflect.TypeOf((*MockRepository)(nil).FindWithOperations), arg0, arg1, arg2, arg3)
}
