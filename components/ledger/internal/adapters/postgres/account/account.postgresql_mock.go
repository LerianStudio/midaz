...
// Source: github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/account (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=account.postgresql_mock.go --package=account github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/account Repository
//
...
// CountByHolderID mocks base method.
func (m *MockRepository) CountByHolderID(ctx context.Context, organizationID, holderID uuid.UUID) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountByHolderID", ctx, organizationID, holderID)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountByHolderID indicates an expected call of CountByHolderID.
func (mr *MockRepositoryMockRecorder) CountByHolderID(ctx, organizationID, holderID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountByHolderID", reflect.TypeOf((*MockRepository)(nil).CountByHolderID), ctx, organizationID, holderID)
}
