...
// Source: github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/organization (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=organization.postgresql_mock.go --package=organization . Repository
//
...
func (m *MockRepository) Count(arg0 context.Context) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1 http.Pagination) ([]*mmodel.Organization, error) {
	m.ctrl.T.Helper()
