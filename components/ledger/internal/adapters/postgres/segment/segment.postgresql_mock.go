...
// Source: github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/segment (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=segment.postgresql_mock.go --package=segment . Repository
//
