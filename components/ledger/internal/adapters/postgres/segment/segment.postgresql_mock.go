...
// Source: github.com/LerianStudio/midaz/v3/components/ledger/internal/adapters/postgres/segment (interfaces: Repository)
//
...
func (m *MockRepository) ExistsByName(ctx context.Context, organizationID, ledgerID uuid.UUID, name string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExistsByName", ctx, organizationID, ledgerID, name)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) ExistsByName(ctx, organizationID, ledgerID, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
