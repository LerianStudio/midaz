...
// Source: github.com/LerianStudio/midaz/components/ledger/internal/adapters/postgres/product (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=product.mock.go --package=product . Repository
//
...
func (m *MockRepository) FindAll(ctx context.Context, organizationID, ledgerID uuid.UUID, limit, page int) ([]*mmodel.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAll", ctx, organizationID, ledgerID, limit, page)
	ret0, _ := ret[0].([]*mmodel.Product)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindAll(ctx, organizationID, ledgerID, limit, page any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockRepository)(nil).FindAll), ctx, organizationID, ledgerID, limit, page)
}
