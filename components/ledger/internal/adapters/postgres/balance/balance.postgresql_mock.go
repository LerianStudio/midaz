...
// Source: components/ledger/internal/adapters/postgres/balance/balance.postgresql.go
//
// Generated by this command:
//
//	mockgen -source=components/ledger/internal/adapters/postgres/balance/balance.postgresql.go -destination=components/ledger/internal/adapters/postgres/balance/balance.postgresql_mock.go -package=balance
//
...
func (m *MockRepository) ListAll(ctx context.Context, organizationID, ledgerID uuid.UUID, filter http0.QueryHeader) ([]*mmodel.Balance, http.CursorPagination, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) ListAllByAccountID(ctx context.Context, organizationID, ledgerID, accountID uuid.UUID, filter http0.QueryHeader) ([]*mmodel.Balance, http.CursorPagination, error) {
	m.ctrl.T.Helper()
