...
// Source: github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/operation (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=operation.postgresql_mock.go --package=operation . Repository
//
...
func (m *MockRepository) CreateBulkTx(ctx context.Context, tx repository.DBExecutor, operations []*Operation) (*repository.BulkInsertResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateBulkTx", ctx, tx, operations)
	ret0, _ := ret[0].(*repository.BulkInsertResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) CreateBulkTx(ctx, tx, operations any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateBulkTx", reflect.TypeOf((*MockRepository)(nil).CreateBulkTx), ctx, tx, operations)
}
...
func (m *MockRepository) FindAllByAccount(ctx context.Context, organizationID, ledgerID, accountID uuid.UUID, opFilter OperationFilter, filter http0.Pagination) ([]*Operation, http.CursorPagination, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAllByAccount", ctx, organizationID, ledgerID, accountID, opFilter, filter)
	ret0, _ := ret[0].([]*Operation)
	ret1, _ := ret[1].(http.CursorPagination)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockRepositoryMockRecorder) FindAllByAccount(ctx, organizationID, ledgerID, accountID, opFilter, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAllByAccount", reflect.TypeOf((*MockRepository)(nil).FindAllByAccount), ctx, organizationID, ledgerID, accountID, opFilter, filter)
}
...
func (m *MockRepository) FindLastOperationsForAccountBeforeTimestamp(ctx context.Context, organizationID, ledgerID, accountID uuid.UUID, timestamp time.Time, filter http0.Pagination) ([]*Operation, http.CursorPagination, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindLastOperationsForAccountBeforeTimestamp", ctx, organizationID, ledgerID, accountID, timestamp, filter)
	ret0, _ := ret[0].([]*Operation)
	ret1, _ := ret[1].(http.CursorPagination)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
// FindLastOperationsForAccountBeforeTimestamp indicates an expected call of FindLastOperationsForAccountBeforeTimestamp.
func (mr *MockRepositoryMockRecorder) FindLastOperationsForAccountBeforeTimestamp(ctx, organizationID, ledgerID, accountID, timestamp, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindLastOperationsForAccountBeforeTimestamp", reflect.TypeOf((*MockRepository)(nil).FindLastOperationsForAccountBeforeTimestamp), ctx, organizationID, ledgerID, accountID, timestamp, filter)
}
...
// ListLatestByBalances mocks base method.
func (m *MockRepository) ListLatestByBalances(ctx context.Context, organizationID, ledgerID uuid.UUID, refs []BalanceHWMRef) (map[string]*Operation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLatestByBalances", ctx, organizationID, ledgerID, refs)
	ret0, _ := ret[0].(map[string]*Operation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListLatestByBalances indicates an expected call of ListLatestByBalances.
func (mr *MockRepositoryMockRecorder) ListLatestByBalances(ctx, organizationID, ledgerID, refs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLatestByBalances", reflect.TypeOf((*MockRepository)(nil).ListLatestByBalances), ctx, organizationID, ledgerID, refs)
}
