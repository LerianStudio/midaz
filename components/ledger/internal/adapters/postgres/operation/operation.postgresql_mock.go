...
//
//	mockgen --destination=components/ledger/internal/adapters/postgres/operation/operation.postgresql_mock.go --package=operation github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/operation Repository
//
