...
// Source: github.com/LerianStudio/midaz/v4/components/ledger/internal/adapters/postgres/ledger (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=ledger.postgresql_mock.go --package=ledger . Repository
//
...
func (m *MockRepository) Count(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Count", ctx, organizationID)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) Count(ctx, organizationID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Count", reflect.TypeOf((*MockRepository)(nil).Count), ctx, organizationID)
}
...
func (m *MockRepository) FindAll(ctx context.Context, organizationID uuid.UUID, filter http.QueryHeader) ([]*mmodel.Ledger, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindByNameExcludingID(ctx context.Context, organizationID uuid.UUID, name string, excludeID uuid.UUID) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByNameExcludingID", ctx, organizationID, name, excludeID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindByNameExcludingID(ctx, organizationID, name, excludeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByNameExcludingID", reflect.TypeOf((*MockRepository)(nil).FindByNameExcludingID), ctx, organizationID, name, excludeID)
}
...
func (m *MockRepository) UpdateSettingsAtomic(ctx context.Context, organizationID, ledgerID uuid.UUID, mergeFn func(map[string]any) (map[string]any, error)) (map[string]any, error) {
	m.ctrl.T.Helper()
