...
func (m *MockRepository) Count(arg0 context.Context, arg1 uuid.UUID) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Count(arg0, arg1 any) *gomock.Call {
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1 uuid.UUID, arg2 http.Pagination) ([]*mmodel.Ledger, error) {
	m.ctrl.T.Helper()
