...
// Source: github.com/LerianStudio/midaz/v3/components/ledger/internal/adapters/mongodb/transaction (interfaces: Repository)
//
...
func (m *MockRepository) CreateBulk(ctx context.Context, collection string, metadata []*Metadata) (*repository.MongoDBBulkInsertResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateBulk", ctx, collection, metadata)
...
func (mr *MockRepositoryMockRecorder) CreateBulk(ctx, collection, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateBulk", reflect.TypeOf((*MockRepository)(nil).CreateBulk), ctx, collection, metadata)
}
