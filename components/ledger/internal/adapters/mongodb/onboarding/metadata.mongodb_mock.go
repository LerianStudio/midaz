...
// Source: github.com/LerianStudio/midaz/v3/components/ledger/internal/adapters/mongodb/onboarding (interfaces: Repository)
//
...
func (m *MockRepository) CreateBulk(ctx context.Context, collection string, metadataList []*Metadata) (*repository.MongoDBBulkInsertResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateBulk", ctx, collection, metadataList)
	ret0, _ := ret[0].(*repository.MongoDBBulkInsertResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateBulk indicates an expected call of CreateBulk.
func (mr *MockRepositoryMockRecorder) CreateBulk(ctx, collection, metadataList any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateBulk", reflect.TypeOf((*MockRepository)(nil).CreateBulk), ctx, collection, metadataList)
}

// CreateIndex mocks base method.
func (m *MockRepository) CreateIndex(ctx context.Context, collection string, input *mmodel.CreateMetadataIndexInput) (*mmodel.MetadataIndex, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateIndex", ctx, collection, input)
...
func (mr *MockRepositoryMockRecorder) CreateIndex(ctx, collection, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateIndex", reflect.TypeOf((*MockRepository)(nil).CreateIndex), ctx, collection, input)
}
...
func (m *MockRepository) FindAllIndexes(ctx context.Context, collection string) ([]*mmodel.MetadataIndex, error) {
	m.ctrl.T.Helper()
