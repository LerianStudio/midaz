...
func (uc *UseCase) ClaimRevert(ctx context.Context, organizationID, ledgerID, originID, reverseID uuid.UUID) (*revertclaim.Claim, bool, error) {
...
func (uc *UseCase) CompleteRevertClaim(ctx context.Context, organizationID, ledgerID, originID, reverseID uuid.UUID) error {
