...
var spanLogClassGateBaseline = []string{
	"create_account.go:61",
	"create_account.go:106",
	"create_account.go:147",
	"create_account.go:185",
	"create_account.go:207",
	"create_account.go:222",
	"create_account_type.go:66",
	"create_account_type.go:74",
	"create_asset.go:79",
	"create_asset.go:99",
	"create_asset.go:110",
	"create_asset.go:124",
	...
	"create_onboarding_metadata.go:41",
	"create_operation_route.go:58",
	"create_operation_route.go:76",
	"create_organization.go:72",
	"create_organization.go:86",
	"create_portfolio.go:52",
	"create_portfolio.go:72",
	"create_portfolio.go:83",
	"create_segment.go:52",
	"create_segment.go:70",
	"create_segment.go:78",
	"create_segment.go:88",
	...
	"delete_account.go:77",
	"delete_account_type.go:53",
	...
	"delete_portfolio.go:51",
	"delete_segment.go:51",
	"transition_pending_steps.go:78",
	"update_account_type.go:64",
	"update_account_type.go:73",
	"update_asset.go:60",
	"update_asset.go:71",
	...
	"update_ledger.go:58",
	"update_ledger.go:68",
	"update_onboarding_metadata.go:27",
	"update_operation.go:56",
	"update_operation_route.go:64",
	"update_operation_route.go:73",
	"update_organization.go:86",
	"update_organization.go:96",
	"update_portfolio.go:59",
	"update_portfolio.go:71",
	"update_segment.go:87",
	"update_segment.go:97",
