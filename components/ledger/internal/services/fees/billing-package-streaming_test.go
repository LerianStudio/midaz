...
func TestCreateBillingPackage_EmitsCreatedEvent(t *testing.T) {
	...
	pkgStreaming.AssertEventEmitted(t, mock, "fee_billing_packages", "created")

	req := findEmittedByKey(t, mock, "fee_billing_packages", "created")
...
func TestUpdateBillingPackage_EmitsUpdatedEvent(t *testing.T) {
	...
	pkgStreaming.AssertEventEmitted(t, mock, "fee_billing_packages", "updated")

	req := findEmittedByKey(t, mock, "fee_billing_packages", "updated")
...
func TestDeleteBillingPackage_EmitsDeletedEvent(t *testing.T) {
	...
	pkgStreaming.AssertEventEmitted(t, mock, "fee_billing_packages", "deleted")

	req := findEmittedByKey(t, mock, "fee_billing_packages", "deleted")
	assert.Equal(t, bpID.String(), req.Subject)
