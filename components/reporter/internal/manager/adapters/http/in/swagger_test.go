...
import (
	...
	"github.com/LerianStudio/midaz/v4/components/reporter/api"
)
...
func TestSwaggerSpec_SecurityDefinitions(t *testing.T) {
	...
	// test file:   components/reporter/internal/manager/adapters/http/in/swagger_test.go
	// swagger.json: components/reporter/api/swagger.json
