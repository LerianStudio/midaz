    ...
    "paths": {
        ...
        "/v1/deadlines": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Deadline Input",
                        "name": "deadline",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/CreateDeadlineInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/deadlines/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Deadline Update Input",
                        "name": "deadline",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/UpdateDeadlineInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/deadlines/{id}/deliver": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Deliver Deadline Input",
                        "name": "deadline",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/DeliverDeadlineInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "type": "integer",
                        "default": 7,
                        "description": "Number of days for error period",
                        "name": "errorPeriodDays",
                        "in": "query"
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "format": "uuid",
                        "description": "Template UUID (also accepts templateId)",
                        "name": "template_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "format": "date",
                        "description": "Created at date, YYYY-MM-DD (also accepts createdAt)",
                        "name": "created_at",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "format": "date",
                        "description": "Filter window start, YYYY-MM-DD",
                        "name": "start_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "format": "date",
                        "description": "Filter window end, YYYY-MM-DD",
                        "name": "end_date",
                        "in": "query"
                    },
                    {
                    ...
                    "201": {
                        ...
                        "headers": {
                            "X-Idempotency-Replayed": {
                                "type": "string",
                                "description": "Set to 'true' when the response is a replay of a previously processed idempotent request"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "headers": {
                            "Content-Disposition": {
                                "type": "string",
                                "description": "attachment; filename=report.pdf"
                            },
                            "Content-Type": {
                                "type": "string",
                                "description": "application/pdf | text/html | application/xml | text/csv"
                            }
                        }
                    },
                    "400": {
        ...
        "/v1/templates": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Output format (html, pdf, txt, xml)",
                        "name": "outputFormat",
                        "in": "formData",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "CreateDeadlineInput": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Monthly regulatory compliance report"
                },
                "dueDate": {
                    "type": "string",
                ...
                "name": {
                    "type": "string",
                    "example": "Monthly Regulatory Report"
                },
                "notifyDaysBefore": {
                    "type": "integer",
                    "example": 5
        ...
        "CreateReportInput": {
            "description": "CreateReportInput is the input payload to create a report.  The Filters field is a three-level map keyed by datasource → table → field, with each leaf being a FilterCondition. Example: { \"accounts\": { \"account\": { \"status\": {\"eq\": [\"ACTIVE\"]}, \"balance\": {\"gte\": [0], \"lte\": [10000]} } } }",
            "type": "object",
            "required": [
                "filters",
                "templateId"
        ...
        "ErrorMetrics": {
            ...
            "properties": {
                "previousPeriodTotal": {
                    "description": "PreviousPeriodTotal is the error count for the same-length window immediately before the current period.",
                    "type": "integer",
                    "example": 12
                },
                "total": {
                    "description": "Total is the error count within the current period window.",
                    "type": "integer",
                    "example": 7
                }
            }
        ...
        "MetricsResponse": {
            ...
            "properties": {
                "dataSources": {
                    "description": "DataSources is the number of external data sources currently registered.",
                    "type": "integer",
                    "example": 3
                },
                "errors": {
                    "description": "Errors contains error counters for the current and previous period.",
                    "allOf": [
                        {
                ...
                "reports": {
                    "description": "Reports is the total number of report executions recorded.",
                    "type": "integer",
                    "example": 156
                },
                "templates": {
                    "description": "Templates is the total number of report templates registered in the system.",
                    "type": "integer",
                    "example": 42
                }
            }
        ...
        "NotificationItem": {
            ...
            "properties": {
                "color": {
                    "description": "Color is the hex colour code used in the UI for this deadline.",
                    "type": "string",
                    "example": "#ef4444"
                },
                "daysUntilDue": {
                    "description": "DaysUntilDue is the number of days until (positive) or past (negative) the due date.",
                    "type": "integer",
                    "example": 3
                },
                "description": {
                    "description": "Description is an optional longer description of the deadline.",
                    "type": "string",
                    "example": "Monthly regulatory report"
                },
                "dueDate": {
                    "description": "DueDate is the ISO-8601 timestamp when the deadline falls due.",
                    "type": "string",
                    "example": "2026-07-31T00:00:00Z"
                },
                "frequency": {
                    "description": "Frequency describes how often the deadline recurs (e.g. \"monthly\", \"annual\").",
                    "type": "string",
                    "example": "monthly"
                },
                "id": {
                    "description": "ID is the unique identifier of the deadline.",
                    "type": "string",
                    "example": "00000000-0000-0000-0000-000000000001"
                },
                "monthsOfYear": {
                    "description": "MonthsOfYear lists the months (1-12) the deadline applies to, when frequency is not every month.",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    },
                ...
                "name": {
                    "description": "Name is the human-readable label of the deadline.",
                    "type": "string",
                    "example": "CADOC 4010"
                },
                "notifyDaysBefore": {
                    "description": "NotifyDaysBefore is how many days ahead of the due date this notification window opens.",
                    "type": "integer",
                    "example": 5
                },
                "severity": {
                    "description": "Severity is the urgency level: \"overdue\", \"warning\", or \"info\".",
                    "type": "string",
                    "example": "warning"
                },
                "type": {
                    "description": "Type categorises the deadline (e.g. \"regulatory\", \"custom\").",
                    "type": "string",
                    "example": "regulatory"
                }
            }
        ...
        "NotificationResponse": {
            ...
            "properties": {
                "items": {
                    "description": "Items is the list of deadline notifications within their alert window, sorted by urgency.",
                    "type": "array",
                    "items": {
                ...
                "total": {
                    "description": "Total is the number of notifications returned.",
                    "type": "integer",
                    "example": 3
                }
            }
