...
// Source: github.com/LerianStudio/midaz/v3/components/reporter/pkg/rabbitmq (interfaces: ProducerRepository)
//
// Generated by this command:
//
//	mockgen --destination=producer.mock.go --package=rabbitmq --copyright_file=../../COPYRIGHT . ProducerRepository
//
...
func (m *MockProducerRepository) ProducerDefault(ctx context.Context, exchange, key string, message model.ReportMessage) (*string, error) {
	m.ctrl.T.Helper()
