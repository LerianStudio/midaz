...
echo "window.RUNTIME_ENV = $(node -p 'JSON.stringify({
  ...
  NEXT_PUBLIC_MIDAZ_CONSOLE_ACCOUNT_TYPE_VALIDATION_ENABLED: process.env.NEXT_PUBLIC_MIDAZ_CONSOLE_ACCOUNT_TYPE_VALIDATION_ENABLED,
  NEXT_PUBLIC_MIDAZ_ACCOUNT_TYPE_VALIDATION: process.env.NEXT_PUBLIC_MIDAZ_ACCOUNT_TYPE_VALIDATION
