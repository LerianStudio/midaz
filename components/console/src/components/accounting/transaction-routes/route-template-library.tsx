...
export function RouteTemplateLibrary({
  onSelectTemplate,
  isOpen,
  onClose
}: RouteTemplateLibraryProps) {
  ...
  const templatesByCategory = mockRouteTemplates.reduce(
    (acc, template) => {
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <Badge
                  className={`${categoryColors[template.category]} mt-1 text-xs`}
                >
                  {template.category}
                </Badge>
              </div>
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-h-[80vh] max-w-6xl overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Select a pre-built template to get started with your transaction
              route configuration.
            </DialogDescription>
          </DialogHeader>
          {content}
