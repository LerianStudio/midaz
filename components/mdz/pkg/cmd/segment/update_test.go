...
// This file contains the update_test command implementation.
...
func Test_newCmdSegmentUpdate(t *testing.T) {
	t.Run("with flags", func(t *testing.T) {
		...
		orgFactory := factorySegmentUpdate{
		...
		cmd := newCmdSegmentUpdate(&orgFactory)
		cmd.SetArgs([]string{
			"--organization-id", "123",
			"--ledger-id", "321",
			"--segment-id", "412",
		...
		assert.Contains(t, output, "The Segment 412 has been successfully updated.")
	})
