...
# Use the shared tag-aware discovery and exact selected-test filter. The old
# filename-based override did not populate tagged_tests and silently lost tests
# whose names did not end in _integration_test.go.
