...
// flushing any buffered final log line first. The context is threaded into the
// flush so a shutdown Sync still honors SIGTERM.
func (m *CELRuleMigration) Close(ctx context.Context) error {
