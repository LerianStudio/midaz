...
type Config struct {
	...
	// an unset bool is false); operators opt in with OPENAPI_DOCS_ENABLED=true. Same
	// name and default on the ledger component.
	OpenAPIDocsEnabled bool `env:"OPENAPI_DOCS_ENABLED"`
