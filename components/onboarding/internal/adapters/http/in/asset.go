...
func (handler *AssetHandler) CreateAsset(a any, c *fiber.Ctx) error {
	...
	payload, ok := a.(*mmodel.CreateAssetInput)
	if !ok {
...
func (handler *AssetHandler) GetAllAssets(c *fiber.Ctx) error {
	...
	if headerParams.Metadata != nil {
		...
		if err != nil {
			...
			logger.Errorf("Failed to retrieve all Assets, Error: %s", err)
...
func (handler *AssetHandler) GetAssetByID(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		logger.Errorf("Failed to retrieve Asset with Ledger ID: %s and Asset ID: %s, Error: %s", ledgerID.String(), id.String(), err)
...
func (handler *AssetHandler) UpdateAsset(a any, c *fiber.Ctx) error {
	...
	payload, ok := a.(*mmodel.UpdateAssetInput)
	if !ok {
		return http.WithError(c, fiber.NewError(fiber.StatusBadRequest, "invalid payload type"))
	}
	...
	if err != nil {
		...
		logger.Errorf("Failed to update Asset with ID: %s, Error: %s", id.String(), err)
	...
	if err != nil {
		...
		logger.Errorf("Failed to get update Asset with ID: %s, Error: %s", id.String(), err)
...
func (handler *AssetHandler) DeleteAssetByID(c *fiber.Ctx) error {
	...
	if err := handler.Command.DeleteAssetByID(ctx, organizationID, ledgerID, id); err != nil {
		...
		logger.Errorf("Failed to remove Asset with Ledger ID: %s and Asset ID: %s, Error: %s", ledgerID.String(), id.String(), err)
...
func (handler *AssetHandler) CountAssets(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		logger.Errorf("Failed to count assets, Error: %s", err)
