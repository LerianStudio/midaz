...
func (m *MockRepository) FindAllWithDeleted(arg0 context.Context, arg1, arg2 uuid.UUID, arg3 http.Pagination) ([]*mmodel.Asset, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAllWithDeleted", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]*mmodel.Asset)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindAllWithDeleted(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAllWithDeleted", reflect.TypeOf((*MockRepository)(nil).FindAllWithDeleted), arg0, arg1, arg2, arg3)
}
