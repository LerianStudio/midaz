...
// Source: github.com/LerianStudio/midaz/v3/components/onboarding/internal/adapters/postgres/accounttype (interfaces: Repository)
//
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1, arg2 uuid.UUID, arg3 http.Pagination) ([]*mmodel.AccountType, http.CursorPagination, error) {
	m.ctrl.T.Helper()
