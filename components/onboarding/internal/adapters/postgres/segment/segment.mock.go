...
// Source: github.com/LerianStudio/midaz/components/onboarding/internal/adapters/postgres/segment (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=segment.mock.go --package=segment . Repository
//
