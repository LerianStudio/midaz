...
// multiTenantEnabled && pgManager != nil, for any combination of the two fields
// generated by quick.Check.
//
...
func TestProperty_BalanceSyncWorker_PredicateEqualsEnabledAndPGManagerNonNil(t *testing.T) {
	...
	property := func(enabled bool, hasPGManager bool) bool {
		...
		expected := enabled && hasPGManager

		// Property: predicate result MUST equal (enabled && pgManager != nil).
		if got != expected {
			return false
		}
	...
	require.NoError(t, err,
		"Property violated: BalanceSyncWorker.isMultiTenantReady() != (multiTenantEnabled && pgManager != nil)")
}
...
func TestProperty_RedisQueueConsumer_PredicateEqualsEnabledAndPGManagerNonNil(t *testing.T) {
	...
	err := quick.Check(property, &quick.Config{MaxCount: 100})
	require.NoError(t, err,
		"Property violated: RedisQueueConsumer.isMultiTenantReady() != (multiTenantEnabled && pgManager != nil)")
}
...
func TestProperty_NewRedisQueueConsumerMultiTenant_PreservesBaseFields(t *testing.T) {
	...
	property := func(enabled bool, hasPGManager bool) bool {
		...
		expectedReady := enabled && hasPGManager
...
func TestProperty_MultiTenantConstructors_NeverPanic(t *testing.T) {
	...
	property := func(
		...
		expectedWorkerReady := workerEnabled && wPGManager != nil
		...
		expectedConsumerReady := consumerEnabled && cPGManager != nil
