...
func initRedis(cfg *Config, logger libLog.Logger, balanceSyncWorkerEnabled bool) (*redis.RedisConsumerRepository, *libRedis.Client, error) {
...
func initBalanceSyncWorker(opts *Options, cfg *Config, logger libLog.Logger, commandUC *command.UseCase, redisConn *libRedis.Client, pgManager *tmpostgres.Manager) *BalanceSyncWorker {
	...
	if !cfg.BalanceSyncWorkerEnabled {
		logger.Log(context.Background(), libLog.LevelInfo, "BalanceSyncWorker disabled.")
		return nil
	}
...
func InitServersWithOptions(opts *Options) (*Service, error) {
	...
	logger.Log(context.Background(), libLog.LevelInfo, fmt.Sprintf("BalanceSyncWorker: BALANCE_SYNC_WORKER_ENABLED=%v", balanceSyncWorkerEnabled))
