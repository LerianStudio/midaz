...
func TestBalanceCompositeKeyFromRedisKey(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "valid key format with trailing hash (empty partition) defaults to default",
			redisKey:    "balance:{transactions}:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:@account#",
			wantOrgID:   uuid.MustParse("11111111-1111-1111-1111-111111111111"),
			wantLedger:  uuid.MustParse("22222222-2222-2222-2222-222222222222"),
			wantAccount: "@account",
		...
		{
			name:        "valid key format with whitespace partition defaults to default",
			redisKey:    "balance:{transactions}:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:@account#   ",
			wantOrgID:   uuid.MustParse("11111111-1111-1111-1111-111111111111"),
			wantLedger:  uuid.MustParse("22222222-2222-2222-2222-222222222222"),
			wantAccount: "@account",
		...
		{
			name:        "valid key format with alias containing colons and trailing hash",
			redisKey:    "balance:{transactions}:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:test:account:100#",
			wantOrgID:   uuid.MustParse("11111111-1111-1111-1111-111111111111"),
			wantLedger:  uuid.MustParse("22222222-2222-2222-2222-222222222222"),
			wantAccount: "test:account:100",
			wantPartKey: "default",
