...
// Source: github.com/LerianStudio/midaz/components/transaction/internal/adapters/mongodb (interfaces: Repository)
//
...
func (m *MockRepository) FindList(arg0 context.Context, arg1 string, arg2 any) ([]*Metadata, error) {
	m.ctrl.T.Helper()
