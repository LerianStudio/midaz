...
//
// Enables flexible, schema-less storage for transaction and operation custom attributes
// without requiring PostgreSQL schema changes. Supports batch operations for efficiency.
//
