...
func (m *MockRepository) FindAll(ctx context.Context, organizationID, ledgerID, transactionID uuid.UUID, limit, page int) ([]*Operation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAll", ctx, organizationID, ledgerID, transactionID, limit, page)
	ret0, _ := ret[0].([]*Operation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindAll(ctx, organizationID, ledgerID, transactionID, limit, page any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockRepository)(nil).FindAll), ctx, organizationID, ledgerID, transactionID, limit, page)
}

// FindAllByAccount mocks base method.
func (m *MockRepository) FindAllByAccount(ctx context.Context, organizationID, ledgerID, accountID uuid.UUID, limit, page int) ([]*Operation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAllByAccount", ctx, organizationID, ledgerID, accountID, limit, page)
	ret0, _ := ret[0].([]*Operation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindAllByAccount(ctx, organizationID, ledgerID, accountID, limit, page any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAllByAccount", reflect.TypeOf((*MockRepository)(nil).FindAllByAccount), ctx, organizationID, ledgerID, accountID, limit, page)
}

// FindAllByPortfolio mocks base method.
func (m *MockRepository) FindAllByPortfolio(ctx context.Context, organizationID, ledgerID, portfolioID uuid.UUID, limit, page int) ([]*Operation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAllByPortfolio", ctx, organizationID, ledgerID, portfolioID, limit, page)
	ret0, _ := ret[0].([]*Operation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindAllByPortfolio(ctx, organizationID, ledgerID, portfolioID, limit, page any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAllByPortfolio", reflect.TypeOf((*MockRepository)(nil).FindAllByPortfolio), ctx, organizationID, ledgerID, portfolioID, limit, page)
}
