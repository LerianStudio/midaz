...
// Service identification constants used for telemetry and middleware.
const (
	midazName   = "midaz"   // Service name identifier
	routingName = "routing" // Routing component identifier
)
