...
// Source: ./components/transaction/internal/adapters/redpanda/consumer.redpanda.go
...
func (m *MockConsumerRepository) Register(topicName string, handler QueueHandlerFunc) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Register", topicName, handler)
}

// Register indicates an expected call of Register.
func (mr *MockConsumerRepositoryMockRecorder) Register(topicName, handler any) *gomock.Call {
