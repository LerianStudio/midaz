...
// Source: github.com/LerianStudio/midaz/components/transaction/internal/domain/transaction (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=../../gen/mock/transaction/transaction_mock.go --package=mock . Repository
//
...
import (
	...
	transaction "github.com/LerianStudio/midaz/components/transaction/internal/domain/transaction"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *transaction.Transaction) (*transaction.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Find(arg0 context.Context, arg1, arg2, arg3 uuid.UUID) (*transaction.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1, arg2 uuid.UUID, arg3, arg4 int) ([]*transaction.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) ListByIDs(arg0 context.Context, arg1, arg2 uuid.UUID, arg3 []uuid.UUID) ([]*transaction.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1, arg2, arg3 uuid.UUID, arg4 *transaction.Transaction) (*transaction.Transaction, error) {
	m.ctrl.T.Helper()
