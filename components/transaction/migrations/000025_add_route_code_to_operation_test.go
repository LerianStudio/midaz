...
func TestMigration000025_FilesExist(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			filename: "000025_add_route_code_to_operation.up.sql",
		},
		{
			name:     "down migration file exists",
			filename: "000025_add_route_code_to_operation.down.sql",
		},
	}
...
func TestMigration000025_UpSQL_AddRouteCodeColumn(t *testing.T) {
	t.Parallel()

	dir := migrationsDir(t)
	path := filepath.Join(dir, "000025_add_route_code_to_operation.up.sql")
...
func TestMigration000025_DownSQL_DropRouteCodeColumn(t *testing.T) {
	t.Parallel()

	dir := migrationsDir(t)
	path := filepath.Join(dir, "000025_add_route_code_to_operation.down.sql")
...
func TestMigration000025_UpSQL_IdempotentRerun(t *testing.T) {
	t.Parallel()
...
func TestMigration000025_UpSQL_ExistingRowsUnaffected(t *testing.T) {
	t.Parallel()
