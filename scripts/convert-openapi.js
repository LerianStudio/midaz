...
// Example Request Bodies for Common Endpoints
const requestBodyExamples = {
  ...
  CreateOrganizationInput: {
    ...
    withAddress: {
      summary: "Organization with address",
      value: {
        legalName: "Lerian Financial Services Ltd.",
        legalDocument: "123456789012345",
        doingBusinessAs: "Lerian FS",
  ...
  CreateAccountInput: {
    ...
    investment: {
      ...
      value: {
        ...
        alias: "@equity_investments",
        type: "investment",
        assetCode: "USD",
        portfolioId: "d290f1ee-6c54-4b01-90e6-d701748f0851",
        status: "active",
        metadata: {
          purpose: "investments",
          strategy: "growth",
  ...
  CreateTransactionInput: {
    ...
    multiAsset: {
      summary: "Multi-asset transaction",
      value: {
        entries: [
          {
            accountId: "00000000-0000-0000-0000-000000000001",
  ...
  CreateAssetRateInput: {
    ...
    crypto: {
      summary: "Cryptocurrency exchange rate",
      value: {
        fromAssetCode: "BTC",
        toAssetCode: "USD",
        rate: 58345.67,
        effectiveAt: "2023-04-01T12:00:00Z",
